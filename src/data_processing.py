...
class DataProcessor:
    ...
    def __init__(self, input_file, output_dir):
        ...
        logger.info("DataProcessing initialize.")
    ...
    def filter_users(self, min_rating=400):
        try:
            ...
            logger.info("Filter users successfully.")
    ...
    def scale_rating(self):
        try:
            ...
            logger.info("Scaling the rate done for processing.")
    ...
    def encode_data(self):
        try:
            ...
            logger.info("Encoding and decoding done for users and animes.")
    ...
    def save_artifacts(self):
        try:
            artifacts = {
                ...
                "user2user_decoded" : self.anime2anime_decoded,
    ...
    def process_anime_data(self):
        try:
            ...
            synopsis_df = pd.read_csv(ANIMESYNOPSIS_CSV, low_memory=True)
